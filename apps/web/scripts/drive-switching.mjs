...
await p.locator('select').selectOption('felder-berechnen'); await p.waitForTimeout(150)
await cell('F9').click(); await p.keyboard.type('=SUMME(B2:E2)'); await p.keyboard.press('Enter')
await p.locator('select').selectOption('smv-wahl'); await p.waitForTimeout(150)
