 ...
 *
 * M1, M6 and M7 still to come; M3's addressing work lives inside M2's
 * last two tasks.
 */
export const LESSONS: Lesson[] = [m2Netzwerk, m5Befehle, m4Binaer, m8Abkuerzungen, m9Flussdiagramm]
